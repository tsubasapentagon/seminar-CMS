...
// 主催者情報と、その人が担当するセミナーのリストを一緒にした新しい型
...
export default function ShiftReviewPage() {
  ...
  return (
    <div className="flex">
      {/* Sidebarコンポーネントは<Layout>に移動したため、
          このページが<Layout>でラップされている場合は不要です。
          もしこのページが独立している場合は、<Sidebar />を配置してください。
      */}
